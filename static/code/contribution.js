 ...
 */
    ...
    function Category(idn) {
        ...
        this.idn = idn;
        this.cont_sequence = IdnSequence();
    }
    ...
    // noinspection JSUnusedGlobalSymbols
    Lexi.prototype.define_IDN = function Lexi_define_IDN(name, idn) {
        var that = this;
        that._idn_from_name[name] = idn;
    }

    Object.defineProperties(Lexi.prototype, {
        IDN:  { get: function () {return this._idn_from_name;}}
    });
    ...
    function CategoryLexi(word_class) {
        ...
        Lexi.call(this, word_class);
        this.cat_idns = IdnSequence();
    }
    ...
    //     });
    // };
    // TODO:  Merge .is_authorized() method with is_authorized() function.
